...
export const WheelResultModal = ({ isOpen, onClose, item, itemIndex }: WheelResultModalProps) => {
    if (!item) return null;
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} size='xl' isCentered>
            <ModalOverlay />
            <ModalContent>
                <ModalHeader mr={6} px={{ base: 3, '2xs': 5 }}>
                    <Flex align='center' gap={2}>
                        {/* индекс и название */}
                        <Flex align='center' gap={{ base: 1, '2xs': 2 }}>
                            <Text
                                fontSize={{ base: 'xl', '2xs': '2xl' }}
                                fontWeight='bold'
                                color='blue.600'
                                minW='58px'
                            >
                ...
                <ModalBody pb={6} px={{ base: 3, '2xs': 5 }}>
