...
export const VideoPage = () => {
    ...
    // Пагинация
    const videosPerPage =
        window.innerWidth < 768 ? VIDEOS_PER_PAGE_MOBILE : VIDEOS_PER_PAGE_DESKTOP;
    ...
    useEffect(() => {
        const handleResize = () => {
            if (
                ...
                currentPage > Math.ceil(filteredVideos.length / VIDEOS_PER_PAGE_MOBILE)
            ) {
                setCurrentPage(1);
            }
        };
        ...
        <Container maxW='7xl' py={8} px={{ base: 1, xs: 4 }}>
            <VStack spacing={4} mb={10} textAlign='center'>
                ...
                {currentlyPlaying && (
                    <Text fontSize='sm' color='blue.600' fontStyle='italic'>
                        🎬 Сейчас играет:{' '}
                        {VIDEOS_DATA.find((v) => v.id === currentlyPlaying)?.title}
                    </Text>
                )}
            </VStack>
            ...
            {paginatedVideos.length > 0 ? (
                <>
                    <SimpleGrid columns={{ base: 1, sm: 2, md: 3 }} spacing={6} mb={8}>
                        {paginatedVideos.map((video) => (
                            <Card
                                ...
                                borderWidth='2px'
                                borderColor={
                                    currentlyPlaying === video.id ? 'blue.400' : 'gray.200'
                                }
                                overflow='hidden'
                                ...
                                <AspectRatio ratio={aspectRatio}>
                                    <Box position='relative'>
                                        <video
                                            ...
                                            onLoadedMetadata={(e) =>
                                                handleLoadedMetadata(video.id, e)
                                            }
                                        />
                    ...
                    {/* Пагинация */}
                    {totalPages > 1 && (
                        <Flex justify='center' mt={8} mb={8} flexWrap='wrap' gap={1}>
                            <HStack spacing={2}>
                                <Button
            ...
            >
                ...
                <Box>
                    ...
                    <Text>
                        Все видео материалы на этом сайте размещены исключительно в ознакомительных
                        целях.
                    </Text>
                </Box>
                ...
                <Box>
                    ...
                    <Text mb={3}>
                        Если вы являетесь правообладателем и считаете, что размещение какого-либо
                        материала нарушает ваши авторские права, пожалуйста, свяжитесь с нами для
                        его удаления.
                    </Text>
                    <UnorderedList>
                ...
                <Box>
                    ...
                    <Text>
                        Наша деятельность осуществляется в соответствии с законодательством
                        Республики Беларусь, в частности с Законом "Об авторском праве и смежных
                        правах".
                    </Text>
                </Box>
            </VStack>
