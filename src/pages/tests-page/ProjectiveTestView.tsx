...
const ImageCard: React.FC<ImageCardProps> = ({ imageSrc, title, isSelected, onClick, index }) => (
    <Box
        ...
        onClick={onClick}
    >
        <Image src={imageSrc} alt={title} width='100%' height='180px' objectFit='cover' />
        <Box
            position='absolute'
            top='2'
            right='2'
...
export const ProjectiveTestView: React.FC<ProjectiveTestViewProps> = ({ test }) => {
    ...
    const selectedAnswer: TestAnswer | undefined = answers.find(
        (answer: TestAnswer) => answer.id === selectedAnswerId,
    );
        ...
        return (
            <VStack spacing={6} align='stretch'>
                <Flex justify='space-between' align='center'>
                    ...
                    <Button colorScheme='blue' variant='outline' onClick={handleReset}>
                        Пройти ещё раз
                    </Button>
                </Flex>
